...
default_templates = {
    ...
    "corp_biz_old": " - 개인사업자의 경우, 사업자등록증을 최근 3개월 이내 발급된 것으로 제출해 주시기 바랍니다.",
    "corp_reg_miss": " - 법인등기부등본을 최근 3개월 이내 발급된 제출용으로 제출해 주시기 바랍니다.",
    "corp_reg_view": " - 법인등기부등본을 열람용이 아닌 제출용으로 제출해 주시기 바랍니다.",
...
with st.sidebar:
    error_count_placeholder.info(f"💡 보완 필요: **{total_errors}건**")
